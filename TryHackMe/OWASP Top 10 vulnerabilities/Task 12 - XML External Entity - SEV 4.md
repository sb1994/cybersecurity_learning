...
---
## Task 14 - XML External Entity - DTD - SEV 4
...
Entered the payload in the XML 
```xml
<?xml version="1.0"?>
...
returned the id_rsa for ssh by falcon by catting out the key in the XML response
```shell
